...
parameter <- 'Total Phosphorus - Water - Total'
...
```
We will pass IND, ghm, pm25, ndbi, Impee, elev, roofs,  to our mixed model
...
```{r}
PQL <- glmmPQL(new_result_value ~ IND+ghm+pm25+ndbi+Impee+roofs, data=s8data, random = ~1|Location,family = gaussian(link = 'log'))
...
#removed elev 
PQL2 <-PQL
lm.compare <- lm(log(new_result_value) ~ IND+ghm+pm25+ndbi+Impee+roofs, data = s8data)
summary(PQL2)
summary(lm.compare)
...
glme.equation <- tibble(x = s8data$IND,y = exp(4.606459+6.931916*s8data$IND-2.608815*s8data$ghm+ 2.447038*s8data$pm25+2.650185*s8data$ndbi-3.005394*s8data$Impee +4.317118*s8data$roofs))
lm.equation <- tibble(x = s8data$IND,y = exp(4.2484              +7.9020              *s8data$IND - 3.6501  
                                             *s8data$ghm + 2.8636     * s8data$pm25 + 4.4054 *s8data$ndbi - 4.2754 *s8data$Impee + 5.7668 *s8data$roofs))
...
```{r}
#compare with a linear regression model 
glme.equation <- tibble(x = s8data$roofs,y = exp(4.606459+6.931916*s8data$IND-2.608815*s8data$ghm+ 2.447038*s8data$pm25+2.650185*s8data$ndbi-3.005394*s8data$Impee +4.317118*s8data$roofs))
lm.equation <- tibble(x = s8data$roofs,y = exp(4.2484              +7.9020              *s8data$IND - 3.6501  
                                             *s8data$ghm + 2.8636     * s8data$pm25 + 4.4054 *s8data$ndbi - 4.2754 *s8data$Impee + 5.7668 *s8data$roofs))
